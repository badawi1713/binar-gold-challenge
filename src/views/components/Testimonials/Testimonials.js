      ...
      <div className="w-full">
          ...
          {[0, 1, 2].map((item) => (
            <div key={item}>
              <div className="mx-0 sm:mx-4 md:mx-12 2xl:mx-16">
                <div className="bg-blue-50 p-4 md:px-8 md:py-16 w-full h-full flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-12 rounded-lg">
                  <img
                  ...
                  <div className="flex sm:items-start flex-col gap-2">
                    ...
                    <strong className="text-sm">John Dee 32, Bromo</strong>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="flex items-center justify-center mt-6 gap-6">
          <button
            ...
            className="p-2 bg-white border-gray-400 w-9 h-9 rounded-full border flex justify-center items-center hover:bg-green-200 focus:bg-green-500 focus:text-white focus:border-green-500"
          >
