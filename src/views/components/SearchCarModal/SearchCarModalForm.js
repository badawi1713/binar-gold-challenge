  ...
  return (
    <>
      <form
        id="search-form"
        tabIndex={1}
        className="flex items-end gap-4 flex-row justify-evenly "
      >
        ...
        <div className="form-control">
          ...
          <select className="select select-bordered w-full lg:w-52 text-xs">
            <option disabled>Pilih Kapasitas Mobil</option>
        ...
        <div className="form-control">
          ...
          <select className="select select-bordered w-full lg:w-52 text-xs">
            <option disabled>Pilih Harga Sewa Per hari</option>
            <option>Star Wars</option>
            <option>Harry Potter</option>
            <option>Lord of the Rings</option>
            <option>Planet of the Apes</option>
        ...
        <div className="form-control">
          ...
          <select className="select select-bordered w-full lg:w-52 text-xs">
            <option disabled>Pilih Status Mobil</option>
            <option>Star Wars</option>
            <option>Harry Potter</option>
            <option>Lord of the Rings</option>
            <option>Planet of the Apes</option>
